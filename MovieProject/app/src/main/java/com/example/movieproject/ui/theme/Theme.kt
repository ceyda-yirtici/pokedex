...
object MovieTheme {
    val colors: MovieColors
        @Composable
        get() = LocalMoviesColors.current
}
/**
 * Movie custom Color Palette
 */
@Stable
class MovieColors(
...
fun ProvideMovieColors(
    ...
    CompositionLocalProvider(LocalMoviesColors provides colorPalette, content = content)
}

private val LocalMoviesColors = staticCompositionLocalOf<MovieColors> {
    error("No MovieColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [MovieTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
