...
fun JetsnackScaffold(
    ...
    drawerBackgroundColor: Color = MovieTheme.colors.uiBackground,
    drawerContentColor: Color = MovieTheme.colors.textSecondary,
    drawerScrimColor: Color = MovieTheme.colors.uiBorder,
    backgroundColor: Color = MovieTheme.colors.uiBackground,
